...
- Create a Snapshot: `sandbox.createSnapshot()` / `Sandbox.createSnapshot()`.
- List Snapshots: `Sandbox.listSnapshots()`.
- Delete a Snapshot: `Sandbox.deleteSnapshot()`.
...
- The template argument of `Sandbox.create()` can also be a Snapshot ID or the qualified name of a named Snapshot. For Snapshot limits, see [Snapshots](../04.Features/01.Sandbox/12.Snapshots.md).
