...
- Snapshots: supported. For details, see [Snapshots](../04.Features/01.Sandbox/12.Snapshots.md). Name conflicts, deleting an occupied Snapshot, and overriding environment variables or mounts when restoring from a Snapshot fail; troubleshoot against the Snapshot documentation.
