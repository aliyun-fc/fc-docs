...
FC Agent Sandbox API keys are used to create, connect to, and manage sandboxes. Create and manage them as described in [Create an API Key](../01.Getting%20Started/03.Create%20an%20API%20Key.md). Recommendations:
