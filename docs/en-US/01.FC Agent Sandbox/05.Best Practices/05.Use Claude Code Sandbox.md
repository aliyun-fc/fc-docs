...
- Built a template with `ready` status following [Claude Code Template](../04.Features/02.Templates/07.Other%20Templates/04.Claude%20Code%20Template.md) and noted the template name (referred to as `TEMPLATE_NAME` below)
...
TEMPLATE_NAME = "my-claude-code-template"  # from the Claude Code template guide
...
For MCP support boundaries, see [Claude Code Template](../04.Features/02.Templates/07.Other%20Templates/04.Claude%20Code%20Template.md).

### Extend Capabilities with Skills

The image does not preload custom Skills. For Skill scopes, directory conventions, and trigger behavior, see [Claude Code Template](../04.Features/02.Templates/07.Other%20Templates/04.Claude%20Code%20Template.md). For the complete mechanism, see [Claude Code Skills](https://code.claude.com/docs/en/skills).
...
You can also preload Skills when building a Template (useful for team reuse), see [Claude Code Template](../04.Features/02.Templates/07.Other%20Templates/04.Claude%20Code%20Template.md).
...
| name 'TEMPLATE_NAME' is not defined | Replace `TEMPLATE_NAME` with the template name from [Claude Code Template](../04.Features/02.Templates/07.Other%20Templates/04.Claude%20Code%20Template.md) |
...
- [Claude Code Template](../04.Features/02.Templates/07.Other%20Templates/04.Claude%20Code%20Template.md) (image addresses, build and minimal verification, environment overview)
