...
```
fc-e2b-registry.cn-hangzhou.cr.aliyuncs.com/runtime/base:v0.0.52  →  /.fce2b/envd
```
...
FROM fc-e2b-registry.cn-hangzhou.cr.aliyuncs.com/runtime/base:v0.0.52 AS envd-extract
...
build = Template.build(
    ...
    api_headers={"X-E2B-Template-Build-Mode": "direct"},
...
|---|---|---|
| envd binary | `COPY --from=base:v0.0.52 /.fce2b/envd` | Same (statically linked, works across distros) |
