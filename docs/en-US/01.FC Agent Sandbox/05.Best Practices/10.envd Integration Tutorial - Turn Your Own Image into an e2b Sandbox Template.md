...
```
fc-e2b-registry.cn-hangzhou.cr.aliyuncs.com/runtime/base:v0.0.49  →  /.fce2b/envd
```
...
FROM fc-e2b-registry.cn-hangzhou.cr.aliyuncs.com/runtime/base:v0.0.49 AS envd-extract
...
|---|---|---|
| envd binary | `COPY --from=base:v0.0.49 /.fce2b/envd` | Same (statically linked, works across distros) |
