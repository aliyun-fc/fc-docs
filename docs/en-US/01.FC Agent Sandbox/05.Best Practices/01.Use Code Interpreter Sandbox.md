...
For template parameters and capability differences between the two SDKs, see the [Code Interpreter v1 Template](../04.Features/02.Templates/02.Built-in%20Templates/02.Code%20Interpreter%20v1%20Template.md). For Notebook-style interactive execution, use the `e2b_code_interpreter` SDK to create a Sandbox and call `run_code` directly.
