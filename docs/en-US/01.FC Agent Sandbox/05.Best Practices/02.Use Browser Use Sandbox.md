...
1. Build a business template from the [browser template](../04.Features/02.Templates/07.Examples/01.Browser%20Template.md), such as `my-browser-template`.
...
- [browser template](../04.Features/02.Templates/07.Examples/01.Browser%20Template.md)
