...
Browser Use Sandbox is designed for Agents that need to open web pages, click buttons, fill forms, archive screenshots, or scrape dynamic pages. We recommend creating sandboxes from the [browser template](../04.Features/02.Templates/09.Examples/01.Browser%20Template.md): port 3000 provides the browser service and can be connected through CDP by Puppeteer, Playwright, or BrowserUse.
...
1. Build a business template from the [browser template](../04.Features/02.Templates/09.Examples/01.Browser%20Template.md), such as `my-browser-template`.
...
- [browser template](../04.Features/02.Templates/09.Examples/01.Browser%20Template.md)
