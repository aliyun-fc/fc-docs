...
If you already use E2B, you can keep using the E2B SDK or E2B CLI to connect to FC Agent Sandbox. If this is your first time using the service, start by [creating a Team](02.Create%20a%20Team.md) and [creating an API key](03.Create%20an%20API%20Key.md), and then follow [Use FC Agent Sandbox with the SDK](03.Quickstarts/01.Use%20FC%20Agent%20Sandbox%20with%20the%20SDK.md).
...
A Snapshot captures the filesystem and memory state of a running sandbox. After creation, you can launch sandboxes in the same state in seconds from a Snapshot ID or qualified name. Snapshots are independent of the source sandbox and source template. For details, see [Snapshots](../04.Features/01.Sandbox/12.Snapshots.md).
...
- Start with [Create a Team](02.Create%20a%20Team.md) and [Create an API Key](03.Create%20an%20API%20Key.md), then work through [Use FC Agent Sandbox with the SDK](03.Quickstarts/01.Use%20FC%20Agent%20Sandbox%20with%20the%20SDK.md) to launch your first sandbox.
- To allow RAM users to manage FC Agent Sandbox, read [Configure RAM User Permissions](05.Configure%20RAM%20User%20Permissions.md).
...
- Before moving to production, read [Usage Constraints](06.Usage%20Constraints.md).
- If you are migrating from E2B or need to confirm API boundaries, read [E2B Compatibility](07.E2B%20Compatibility.md).
...
After the quickstart, continue with the feature docs for Sandbox, Templates, Commands, Filesystem, Code Interpreter, Network, and Snapshots.
