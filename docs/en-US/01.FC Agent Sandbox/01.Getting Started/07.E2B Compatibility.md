...
| Snapshots | Compatible | Supports create, list, delete, and restore from a Snapshot ID or qualified name. Available only for the `micro-sandbox` runtime. For details, see [Snapshots](../04.Features/01.Sandbox/12.Snapshots.md). |
