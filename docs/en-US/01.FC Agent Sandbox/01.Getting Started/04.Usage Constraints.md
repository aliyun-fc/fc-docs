...
Create, view, edit, reset, disable, and delete API keys in the Function Compute console, not through the E2B SDK. Disabled or expired API keys cannot authenticate to the data plane. Do not expose full API key values in logs, screenshots, support tickets, or frontend pages. For management recommendations, see [Create an API Key](02.Create%20an%20API%20Key.md).
