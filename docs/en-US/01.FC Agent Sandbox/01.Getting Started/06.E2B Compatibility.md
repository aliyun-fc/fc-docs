...
For connection parameter configuration, see [Usage Constraints](05.Usage%20Constraints.md).
...
If you need persistent storage or cloud data access, use Alibaba Cloud storage services such as NAS or OSS first. Create and manage API keys in the Function Compute console, not through the E2B SDK. For details, see [Create an API Key](03.Create%20an%20API%20Key.md).
