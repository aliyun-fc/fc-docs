...
- You have installed a supported version of the E2B CLI. For version requirements, see [Usage Constraints](../06.Usage%20Constraints.md).
...
Replace `<region>` with the region where FC Agent Sandbox is deployed. For supported regions and endpoint rules, see [Usage Constraints](../06.Usage%20Constraints.md).
