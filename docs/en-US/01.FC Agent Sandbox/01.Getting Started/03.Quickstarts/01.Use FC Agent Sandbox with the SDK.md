...
Pass the API key and endpoint through environment variables. Do not hard-code them in source code. For API key creation and management, see [Create an API Key](../02.Create%20an%20API%20Key.md).
