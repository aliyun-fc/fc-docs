...
Each API key is bound to one Team and inherits that Team's subscription plan and resource group context. For Team creation and management, see [Teams and Subscription Plans](02.Teams%20and%20Subscription%20Plans.md).
...
- A Team already exists under the target resource group. If not, create one in the Create API Key form, or follow [Teams and Subscription Plans](02.Teams%20and%20Subscription%20Plans.md).
