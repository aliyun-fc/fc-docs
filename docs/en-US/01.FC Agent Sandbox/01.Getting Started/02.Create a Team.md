...
When you apply precise authorization, grant only the permissions required for the target Team and its sub-resources based on actual responsibilities. Do not grant access to all Teams under the account when it is not needed.
...
3. If you need persistent storage, create a volume for the Team:
    ...
    - [Mounting OSS with Volumes](../04.Features/07.FC%20Extensions/07.Mounting%20OSS%20with%20Volumes.md)
    - [Mounting AgenticFS with Volumes](../04.Features/07.FC%20Extensions/08.Mounting%20AgenticFS%20with%20Volumes.md)
