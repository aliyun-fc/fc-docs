...
| Lightweight Runtime | No pre-installed data science libraries or higher-level dependencies, and no browser automation service |
...
| Lightweight Tasks | Tasks that do not require pre-installed data science libraries or browser automation capabilities |
...
If you need code interpreter, browser automation, or a combination of both, please choose the [Code Interpreter v1 Template](02.Code Interpreter v1 Template.md), [Browser Template](../07.Other Templates/01.Browser Template.md), or [All-in-One Template](../07.Other Templates/02.All-in-One Template.md) respectively.
...
- [Browser Template](../07.Other Templates/01.Browser Template.md)
- [All-in-One Template](../07.Other Templates/02.All-in-One Template.md)
