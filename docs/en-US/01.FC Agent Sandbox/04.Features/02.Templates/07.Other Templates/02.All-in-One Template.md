...
| --- | --- | --- |
| Container image | `fc-e2b-registry.ap-southeast-1.cr.aliyuncs.com/runtime/all-in-one:v0.0.44` | Prebuilt All-In-One sandbox image |
