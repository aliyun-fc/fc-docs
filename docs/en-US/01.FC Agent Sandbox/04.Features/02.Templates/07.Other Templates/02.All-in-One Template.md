...
| Public connections | Create the sandbox with `secure=True` and `network={"allow_public_traffic": True}` to enable public access, then connect directly to CDP/VNC. Use the SDK for code execution and file operations. |
