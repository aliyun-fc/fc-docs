...
- When creating the Sandbox, you configured the execution Role required by the new storage and the VPC required by AgenticFS through `createSandbox`. This API only appends mounts; it does not add or modify these configurations.
