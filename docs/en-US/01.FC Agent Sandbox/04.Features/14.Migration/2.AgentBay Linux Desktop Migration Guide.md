...
|--------|------|------|
| `linux_latest` (Computer Use) | desktop template (internal image `fc-e2b-registry.cn-beijing.cr.aliyuncs.com/runtime/desktop:v0.0.48`) | The FC image ships with a desktop environment; build it with `Template.build()`, see §4 |
...
FROM_IMAGE = "fc-e2b-registry.cn-beijing.cr.aliyuncs.com/runtime/desktop:v0.0.48"
