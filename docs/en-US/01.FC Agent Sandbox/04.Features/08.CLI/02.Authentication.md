...
By default, the E2B CLI reads environment variables for authentication. When connecting to FC Agent Sandbox, configure the API key, API URL, and domain together. For API key creation and management, see [Create an API Key](../../01.Getting%20Started/03.Create%20an%20API%20Key.md).
...
- The API key was created as described in [Create an API Key](../../01.Getting%20Started/03.Create%20an%20API%20Key.md).
