...
2. 在部署页面，参考以下示例填写配置参数：
  ...
  - **权限配置**：为AgentRun应用授权，以便其能访问模型、工具等云资源。
    ...
    - 如需自定义权限，您也可以点击下拉框右侧的添加按钮![image](../../../../assets/zh-CN/3004314-001-810ac7c6e2.png)，通过**创建角色**手动配置，并为其添加相应的权限策略，详情可参见[按需配置执行角色](https://help.aliyun.com/zh/functioncompute/fc/create-agent-by-code-high-code#a570e95c9ewni)。
  - **大语言模型**：从下拉框中选择您刚刚配置的**qwen3-model**，并选择**qwen3-max**模型。如果您未提前配置，可点击下拉框右侧的添加按钮![image](../../../../assets/zh-CN/3004314-002-810ac7c6e2.png)，按照[准备工作](#准备工作)步骤3立即配置。
  - **浏览器沙箱**：从下拉框中选择您刚刚配置的`sandbox-in-opinion_analysis`，如果您未提前配置，可点击下拉框右侧的添加按钮![image](../../../../assets/zh-CN/3004314-003-810ac7c6e2.png)，按照[准备工作](#准备工作)步骤4立即配置。
  - 点击**确认创建**，等待应用部署完成。
