...
两类 SDK 的模板参数和能力差异见 [code-interpreter-v1 模板](../04.功能说明/02.模板/02.内置模板/02.code-interpreter-v1-模板.md)。需要 Notebook 类交互式执行时，可使用 `e2b_code_interpreter` SDK 直接创建 Sandbox 并调用 `run_code`。
