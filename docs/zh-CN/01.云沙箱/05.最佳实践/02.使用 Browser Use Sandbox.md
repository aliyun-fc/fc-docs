...
Browser Use Sandbox 面向需要访问网页、点击按钮、填写表单、截图归档或抓取动态页面的 Agent。推荐基于 [browser 模板](../04.功能说明/02.Templates/02.内置模板/browser-模板.md) 创建沙箱：3000 端口提供 browser 服务，可通过 CDP 连接 Puppeteer、Playwright 或 BrowserUse。
...
1. 按 [browser 模板](../04.功能说明/02.Templates/02.内置模板/browser-模板.md) 构建业务模板，例如 `my-browser-template`。
...
- [browser 模板](../04.功能说明/02.Templates/02.内置模板/browser-模板.md)
