...
AIO Sandbox 面向“浏览器自动化 + 代码执行 + 文件处理”连续发生的 Agent 任务。推荐基于 [All-In-One 模板](../04.功能说明/02.模板/07.示例/02.all-in-one-模板.md) 创建沙箱：3000 端口提供 browser 服务，5000 端口提供 Code Interpreter/envd 服务。这样，Agent 可以在同一个隔离环境中完成网页访问、截图、下载、数据清洗、代码计算和结果导出。
...
1. 按 [All-In-One 模板](../04.功能说明/02.模板/07.示例/02.all-in-one-模板.md) 构建业务模板，例如 `my-all-in-one-template`。
...
- [All-In-One 模板](../04.功能说明/02.模板/07.示例/02.all-in-one-模板.md)
