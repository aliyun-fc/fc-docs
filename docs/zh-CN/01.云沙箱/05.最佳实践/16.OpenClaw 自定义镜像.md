...
FC E2B 要在浏览器中打开 Gateway Control UI，**须先绑定自定义域名**。默认平台域名（`*.e2b.fc.aliyuncs.com`）会**触发下载而非打开页面**；绑定自定义域名后可正常访问。控制台添加域名、DNS 解析、HTTPS 证书及 SDK 配置的完整步骤，见 [云沙箱自定义域名](../04.功能说明/07.FC%20Extensions/03.自定义域名.md)。
...
| 浏览器触发下载 | 须绑定自定义域名，见 [云沙箱自定义域名](../04.功能说明/07.FC%20Extensions/03.自定义域名.md) 与 [浏览器访问（FC E2B）](#浏览器访问fc-e2b) |
| `sandbox account mismatch` | API Key 与自定义域名须为同一账号，见 [云沙箱自定义域名](../04.功能说明/07.FC%20Extensions/03.自定义域名.md) |
...
- [云沙箱自定义域名](../04.功能说明/07.FC%20Extensions/03.自定义域名.md)
