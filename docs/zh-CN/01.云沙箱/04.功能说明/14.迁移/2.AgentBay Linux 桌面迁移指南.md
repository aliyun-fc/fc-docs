...
以下截图来自基于该 Ubuntu + GNOME `start-desktop` 示例新建的 Sandbox。验证脚本未发送键盘输入，首次截图已直接显示完整桌面，而非 Activities 概览：

![新建 Sandbox 默认显示完整 GNOME 桌面](../../../../../assets/zh-CN/agentbay-gnome-default-desktop.png)
