...
- 如果使用官方镜像，最低要求为 `v0.0.44`；以下示例使用满足该要求的 `v0.0.52`：
  - `fc-e2b-registry.${regionId}.cr.aliyuncs.com/runtime/base:v0.0.52`
  - `fc-e2b-registry.${regionId}.cr.aliyuncs.com/runtime/code-interpreter-v1:v0.0.52`
