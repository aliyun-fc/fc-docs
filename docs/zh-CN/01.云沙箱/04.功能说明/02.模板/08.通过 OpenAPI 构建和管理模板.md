...
云沙箱 OpenAPI 当前支持 Java、Python、Go 和 TypeScript SDK。支持范围、安装方式和版本以[阿里云 SDK & API 说明](https://help.aliyun.com/zh/functioncompute/alibaba-cloud-sdk-api-description)为准：

=== "Java"

    Maven 依赖（版本以 SDK 说明页面为准）：
...
=== "Go"
    ...
    ```bash
    go get github.com/alibabacloud-go/fcsandbox20260509/v2
    ```

=== "TypeScript"

    ```bash
    npm install @alicloud/fcsandbox20260509
    ```
...
以下示例使用云沙箱官方镜像（无需自备 ACR EE 实例）创建模板，轮询构建状态至就绪后删除模板：
...
=== "Java"
    ...
    public class CreateTemplateDemo {
        ...
        public static void main(String[] args) throws Exception {
            ...
            String fromImage = "fc-e2b-registry.cn-beijing.cr.aliyuncs.com/runtime/code-interpreter-v1:v0.0.48";

            // 1. 创建模板并提交首次构建，返回 templateID。
            CreateTemplateRuntimeConfig runtimeConfig = CreateTemplateRuntimeConfig.builder()
                    .cpu(2.0)
                    .memorySize(2048)
                    .diskSize(512)
                    .sandboxConfig(CreateTemplateSandboxConfig.builder().image(fromImage).build())
                    .build();
            CreateTemplateInput body = CreateTemplateInput.builder()
                    .name("pop-demo-" + System.currentTimeMillis() / 1000)
                    .teamId(teamId)
                    .runtimeConfig(runtimeConfig)
                    .build();
            String templateId = popClient
                    .createTemplate(CreateTemplateRequest.builder().body(body).build())
            ...
            while (true) {
                try {
                    got = popClient.getTemplate(templateId,
                            GetTemplateRequest.builder().teamId(teamId).build());
                    state = got.getBody().getStatus().getState();
                    System.out.printf("state: %s%n", state);
                } catch (TeaException e) {
                    if (!"TemplateNotFound".equals(e.getCode())) {
                        throw e;
                    }
                    state = "pending";
                }
            ...
            popClient.deleteTemplate(templateId,
                    DeleteTemplateRequest.builder().teamId(teamId).build());
...
=== "Go"
    ...
    import (
        ...
        fcsandbox20260509 "github.com/alibabacloud-go/fcsandbox20260509/v2/client"
    ...
    func main() {
        ...
        fromImage := "fc-e2b-registry.cn-beijing.cr.aliyuncs.com/runtime/code-interpreter-v1:v0.0.48"
        ...
        reasonMessage := ""
        for {
            got, err := popClient.GetTemplate(templateID, &fcsandbox20260509.GetTemplateRequest{
                TeamId: tea.String(teamID),
            })
            if err != nil {
                var sdkErr *tea.SDKError
                if errors.As(err, &sdkErr) && tea.StringValue(sdkErr.Code) == "TemplateNotFound" {
                    state = "pending"
                } else {
                    panic(err)
                }
        ...
        // 3. 模板就绪后即可用于创建沙箱；不再使用时删除模板清理资源。
        if _, err := popClient.DeleteTemplate(templateID, &fcsandbox20260509.DeleteTemplateRequest{
            TeamId: tea.String(teamID),
        }); err != nil {
            panic(err)
        }
...
=== "TypeScript"
    ...
    async function main() {
      ...
      const fromImage = 'fc-e2b-registry.cn-beijing.cr.aliyuncs.com/runtime/code-interpreter-v1:v0.0.48';
...
=== "Java"
    ...
    CreateTemplateInput body = CreateTemplateInput.builder()
            .name("pop-demo-" + System.currentTimeMillis() / 1000)
            .teamId(teamId)
            .runtimeConfig(CreateTemplateRuntimeConfig.builder()
                    .sandboxConfig(CreateTemplateSandboxConfig.builder()
...
=== "Go"
    ...
    created, err := popClient.CreateTemplate(&fcsandbox20260509.CreateTemplateRequest{
        Body: &fcsandbox20260509.CreateTemplateInput{
            ...
            RuntimeConfig: &fcsandbox20260509.CreateTemplateRuntimeConfig{
                SandboxConfig: &fcsandbox20260509.CreateTemplateSandboxConfig{
                    Image: tea.String("fc-e2b-registry.cn-beijing.cr.aliyuncs.com/runtime/code-interpreter-v1:v0.0.48"),
                },
            },
        },
    })
    ...
    CreateTemplateInput body = CreateTemplateInput.builder()
            ...
            .runtimeConfig(CreateTemplateRuntimeConfig.builder()
                    .sandboxConfig(CreateTemplateSandboxConfig.builder()
                            ...
                            .registryConfig(CreateTemplateSandboxConfigRegistryConfig.builder()
                                    // 凭证缺省时使用 ACR EE 实例临时授权；也可显式传入：
                                    // .authConfig(CreateTemplateSandboxConfigRegistryConfigAuthConfig.builder()
                                    //         .userName("<username>")
                                    //         .password("<password>")
                                    //         .build())
                                    .networkConfig(CreateTemplateSandboxConfigRegistryConfigNetworkConfig.builder()
                                            .vpcId("vpc-xxxxxx")
        ...
        Body: &fcsandbox20260509.CreateTemplateInput{
            ...
            RuntimeConfig: &fcsandbox20260509.CreateTemplateRuntimeConfig{
                SandboxConfig: &fcsandbox20260509.CreateTemplateSandboxConfig{
                    ...
                    RegistryConfig: &fcsandbox20260509.CreateTemplateSandboxConfigRegistryConfig{
                        // 凭证缺省时使用 ACR EE 实例临时授权；也可显式传入：
                        // AuthConfig: &fcsandbox20260509.CreateTemplateSandboxConfigRegistryConfigAuthConfig{
                        //     UserName: tea.String("<username>"),
                        //     Password: tea.String("<password>"),
                        // },
                        NetworkConfig: &fcsandbox20260509.CreateTemplateSandboxConfigRegistryConfigNetworkConfig{
      ...
      body: new $FCSandbox20260509.CreateTemplateInput({
        ...
        runtimeConfig: new $FCSandbox20260509.CreateTemplateRuntimeConfig({
          sandboxConfig: new $FCSandbox20260509.CreateTemplateSandboxConfig({
            image: 'test-registry-vpc.cn-beijing.cr.aliyuncs.com/runtime/python:3.12-v1',
            acrInstanceId: 'cri-xxxxxx',
            registryConfig: new $FCSandbox20260509.CreateTemplateSandboxConfigRegistryConfig({
              // 凭证缺省时使用 ACR EE 实例临时授权；也可显式传入：
              // authConfig: new $FCSandbox20260509.CreateTemplateSandboxConfigRegistryConfigAuthConfig({
              //   userName: '<username>',
              //   password: '<password>',
              // }),
              networkConfig: new $FCSandbox20260509.CreateTemplateSandboxConfigRegistryConfigNetworkConfig({
                vpcId: 'vpc-xxxxxx',
                vSwitchId: 'vsw-xxxxxx',
                securityGroupId: 'sg-xxxxxx',
              }),
                    ...
                    .sandboxConfig(CreateTemplateSandboxConfig.builder()
                            ...
                            .registryConfig(CreateTemplateSandboxConfigRegistryConfig.builder()
                                    ...
                                    .networkConfig(CreateTemplateSandboxConfigRegistryConfigNetworkConfig.builder()
                                            ...
                                            .securityGroupId("sg-xxxxxx")
                                            .build())
                                    .certConfig(CreateTemplateSandboxConfigRegistryConfigCertConfig.builder()
                                            .insecure(true)
                                            .build())
                                    .build())
                            .build())
            ...
            RuntimeConfig: &fcsandbox20260509.CreateTemplateRuntimeConfig{
                SandboxConfig: &fcsandbox20260509.CreateTemplateSandboxConfig{
                    ...
                    RegistryConfig: &fcsandbox20260509.CreateTemplateSandboxConfigRegistryConfig{
                        ...
                        CertConfig: &fcsandbox20260509.CreateTemplateSandboxConfigRegistryConfigCertConfig{
        ...
        runtimeConfig: new $FCSandbox20260509.CreateTemplateRuntimeConfig({
          sandboxConfig: new $FCSandbox20260509.CreateTemplateSandboxConfig({
            ...
            registryConfig: new $FCSandbox20260509.CreateTemplateSandboxConfigRegistryConfig({
              ...
              certConfig: new $FCSandbox20260509.CreateTemplateSandboxConfigRegistryConfigCertConfig({
                insecure: true,
              }),
            }),
          }),
...
=== "Java"
    ...
    CreateTemplateInput body = CreateTemplateInput.builder()
            ...
            .runtimeConfig(CreateTemplateRuntimeConfig.builder()
                    .internetAccess(true)
                    .vpcConfig(CreateTemplateRuntimeConfigVpcConfig.builder()
                            .vpcId("vpc-xxxxxx")
                            .vSwitchIds(java.util.Arrays.asList("vsw-xxxxxx"))
                            .securityGroupId("sg-xxxxxx")
                            .build())
                    .sandboxConfig(CreateTemplateSandboxConfig.builder()
                            .image("fc-e2b-registry.cn-beijing.cr.aliyuncs.com/runtime/code-interpreter-v1:v0.0.48")
    ...
    created, err := popClient.CreateTemplate(&fcsandbox20260509.CreateTemplateRequest{
        Body: &fcsandbox20260509.CreateTemplateInput{
            ...
            RuntimeConfig: &fcsandbox20260509.CreateTemplateRuntimeConfig{
                ...
                VpcConfig: &fcsandbox20260509.CreateTemplateRuntimeConfigVpcConfig{
                    VpcId:           tea.String("vpc-xxxxxx"),
...
=== "TypeScript"
    ...
    const created = await popClient.createTemplate(new $FCSandbox20260509.CreateTemplateRequest({
      body: new $FCSandbox20260509.CreateTemplateInput({
        ...
        runtimeConfig: new $FCSandbox20260509.CreateTemplateRuntimeConfig({
          internetAccess: true,
          vpcConfig: new $FCSandbox20260509.CreateTemplateRuntimeConfigVpcConfig({
            vpcId: 'vpc-xxxxxx',
...
=== "Java"
    ...
    CreateTemplateInput body = CreateTemplateInput.builder()
            ...
            .teamId(teamId)
            .runtimeConfig(CreateTemplateRuntimeConfig.builder()
                    .logConfig(CreateTemplateRuntimeConfigLogConfig.builder()
                            .project("<sls-project>")
...
=== "Go"
    ...
    created, err := popClient.CreateTemplate(&fcsandbox20260509.CreateTemplateRequest{
        Body: &fcsandbox20260509.CreateTemplateInput{
            ...
            TeamId: tea.String(teamID),
            RuntimeConfig: &fcsandbox20260509.CreateTemplateRuntimeConfig{
                LogConfig: &fcsandbox20260509.CreateTemplateRuntimeConfigLogConfig{
...
=== "TypeScript"
    ...
    const created = await popClient.createTemplate(new $FCSandbox20260509.CreateTemplateRequest({
      body: new $FCSandbox20260509.CreateTemplateInput({
        ...
        teamId,
        runtimeConfig: new $FCSandbox20260509.CreateTemplateRuntimeConfig({
          logConfig: new $FCSandbox20260509.CreateTemplateRuntimeConfigLogConfig({
            project: '<sls-project>',
            logstore: '<sls-logstore>',
          }),
          sandboxConfig: new $FCSandbox20260509.CreateTemplateSandboxConfig({
    ...
    CreateTemplateInput body = CreateTemplateInput.builder()
            ...
            .runtimeConfig(CreateTemplateRuntimeConfig.builder()
                    .sandboxConfig(CreateTemplateSandboxConfig.builder()
                            ...
                            .build())
                    .build())
            .buildConfig(CreateTemplateBuildConfig.builder()
                    .copy(CreateTemplateBuildConfigCopy.builder()
                            .enabled(true)
    ...
    created, err := popClient.CreateTemplate(&fcsandbox20260509.CreateTemplateRequest{
        Body: &fcsandbox20260509.CreateTemplateInput{
            ...
            BuildConfig: &fcsandbox20260509.CreateTemplateBuildConfig{
                Copy: &fcsandbox20260509.CreateTemplateBuildConfigCopy{
    ...
    const created = await popClient.createTemplate(new $FCSandbox20260509.CreateTemplateRequest({
      body: new $FCSandbox20260509.CreateTemplateInput({
        ...
        buildConfig: new $FCSandbox20260509.CreateTemplateBuildConfig({
          copy: new $FCSandbox20260509.CreateTemplateBuildConfigCopy({
            enabled: true,
            image: 'registry.example.com/ns/repo:v1-fcsandbox',
          }),
        }),
...
=== "Java"
    ...
    ListTemplatesResponse response = popClient.listTemplates(
            ListTemplatesRequest.builder().teamId(teamId).maxResults(20).build());
    for (var template : response.getBody().getTemplates()) {
...
=== "Go"
    ...
    // 删除模板。
    _, err = popClient.DeleteTemplate(templateID, &fcsandbox20260509.DeleteTemplateRequest{
        TeamId: tea.String(teamID),
    })
    if err != nil {
        panic(err)
...
=== "TypeScript"
    ...
    const response = await popClient.listTemplates(
      new $FCSandbox20260509.ListTemplatesRequest({ teamId, maxResults: 20 }));
...
- 目标镜像与构建复用要有例子。
- 要删除老的《构建自定义镜像模板》，只留下一篇。
- POP 的代码示例，Java、Python、Go、TypeScript 四种语言都要。
