...
base 模板提供最小化的云沙箱运行环境，内置 E2B envd 兼容基础服务。它适合需要通过 E2B 兼容 SDK 管理沙箱生命周期、运行基础命令、访问文件系统或作为自定义能力基线的场景。
...
| 轻量运行环境 | 不预装数据科学库等上层依赖，也不预置浏览器自动化服务 |
...
| 轻量任务 | 不需要预装数据科学库，也不需要浏览器自动化能力的任务 |
...
如果需要代码解释器、浏览器自动化或二者组合能力，请分别选择 [code-interpreter-v1 模板](02.code-interpreter-v1-模板.md)、[browser 模板](../07.其他模板/01.browser-模板.md) 或 [All-In-One 模板](../07.其他模板/02.all-in-one-模板.md)。
...
- [code-interpreter-v1 模板](02.code-interpreter-v1-模板.md)
- [browser 模板](../07.其他模板/01.browser-模板.md)
- [All-In-One 模板](../07.其他模板/02.all-in-one-模板.md)
