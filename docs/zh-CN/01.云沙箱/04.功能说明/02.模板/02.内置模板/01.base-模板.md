...
如果需要代码解释器、浏览器自动化或二者组合能力，请分别选择 [code-interpreter-v1 模板](02.code-interpreter-v1-模板.md)、[browser 模板](../07.示例/01.browser-模板.md) 或 [All-In-One 模板](../07.示例/02.all-in-one-模板.md)。
...
- [browser 模板](../07.示例/01.browser-模板.md)
- [All-In-One 模板](../07.示例/02.all-in-one-模板.md)
