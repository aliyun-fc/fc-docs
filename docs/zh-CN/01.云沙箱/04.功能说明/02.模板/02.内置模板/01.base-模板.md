...
如果需要代码解释器、浏览器自动化或二者组合能力，请分别选择 [code-interpreter-v1 模板](02.code-interpreter-v1-模板.md)、[browser 模板](../09.示例/01.browser-模板.md) 或 [All-In-One 模板](../09.示例/02.all-in-one-模板.md)。
...
- [沙箱模板概述](../02.内置模板.md)
- [构建自定义镜像模板](../04.构建自定义镜像模板.md)
- [生命周期](../../01.沙箱/01.生命周期.md)
- [code-interpreter-v1 模板](02.code-interpreter-v1-模板.md)
- [browser 模板](../09.示例/01.browser-模板.md)
- [All-In-One 模板](../09.示例/02.all-in-one-模板.md)
