...
每个 API Key 绑定一个 Team，并继承该 Team 的订阅计划与资源组上下文。Team 的创建和管理参见[Team 与订阅计划](03.Team%20与订阅计划.md)。
...
- 目标资源组下已有可用 Team；若没有，可在创建 API Key 表单中直接创建，或先参见[Team 与订阅计划](03.Team%20与订阅计划.md)。
