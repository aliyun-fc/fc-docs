...
- 使用 CLI 查看和管理 Sandbox，参见[通过 CLI 使用云沙箱](./通过%20CLI%20使用云沙箱.md)。
- 了解[生命周期](../../功能说明/Sandbox/生命周期.md)、[运行命令](../../功能说明/Commands/运行命令.md)和[读写文件](../../功能说明/Filesystem/读写文件.md)。
